...
var Virtualizer = class {
  constructor(opts) {
    ...
    this.scrollToOffset = (toOffset, { align = "start", behavior = "auto" } = {}) => {
      const offset3 = this.getOffsetForAlignment(toOffset, align);
      const now = this.now();
      this.scrollState = {
        index: null,
        align,
    ...
    this.scrollBy = (delta, { behavior = "auto" } = {}) => {
      const offset3 = this.getScrollOffset() + delta;
      const now = this.now();
      this.scrollState = {
        index: null,
        align: "start",
...
function Ae({ children: e9, enabled: t14 = true }) {
  ...
  } }) : null, size2({ padding: c21, apply({ availableWidth: P7, availableHeight: d14, elements: M11 }) {
