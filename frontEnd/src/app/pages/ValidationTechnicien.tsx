...
export function ValidationTechnicien() {
  const { id } = useParams();
    ...
    <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="overflow-x-auto">
          <table className="w-full min-w-[800px] text-sm text-left">
            ...
            <tbody className="divide-y">
              {demande && (
                <tr className="border border-border transition-colors group">
      ...
      <div className="grid grid-cols-3 gap-2">
        <button
          ...
          className={`p-3 rounded-lg border-2 transition-all ${
            activeStatus === "OK"
              ? "bg-[#E8F5E9] dark:bg-[#19301F] border-[#2E7D32] dark:border-[#4A8F58]"
              : "bg-card border-border hover:border-[#2E7D32] dark:hover:border-[#3F7549]"
          }`}
        >
          <CheckCircle className="w-6 h-6 text-[#2E7D32] dark:text-[#6FAF7B] mx-auto mb-1" />{" "}
          <div className="text-sm font-semibold mb-1 text-center">
            {" "}
            {t("validationTechnicien.decisions.ok")}
          </div>
          <div className="text-xs text-muted-foreground-600 text-center">
        ...
        <button
          ...
          className={`p-3 rounded-lg border-2 transition-all ${
            activeStatus === "NOK"
              ? "bg-[#FFEBEE] dark:bg-[#281A1C] border-[#C62828] dark:border-[#7F3840]"
              : "bg-card border-border hover:border-[#C62828] dark:hover:border-[#71343B]"
          }`}
        >
          <XCircle className="w-6 h-6 text-[#C62828] dark:text-[#B85A64] mx-auto mb-1" />{" "}
          <div className="text-sm font-semibold mb-1 text-center">
            {" "}
        ...
        <button
          ...
          className={`p-3 rounded-lg border-2 transition-all ${
            activeStatus === "OK_SOUS_RESERVE"
              ? "bg-[#FFF3E0] dark:bg-[#302619] border-[#ED6C02] dark:border-[#9A6428]"
              : "bg-card border-border hover:border-[#ED6C02] dark:hover:border-[#815522]"
          }`}
        >
          <AlertTriangle className="w-6 h-6 text-[#ED6C02] dark:text-[#D69A4A] mx-auto mb-1" />{" "}
          <div className="text-sm font-semibold mb-1 text-center">
      ...
      <div className="bg-card rounded-xl shadow-sm p-6">
        ...
        <textarea
          ...
          rows={4}
          className="w-full px-4 py-3  text-muted-foreground-600 border border-border rounded-lg  focus:border-border resize-none"
